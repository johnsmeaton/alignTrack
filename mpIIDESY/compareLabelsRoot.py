...
plane_y_disp_chisq_patch = mpatch.Patch(color='none', label=("Param $\\chi^2_{red}$: " + str(plane_y_disp_chisq)))
plane_rot_chisq_patch = mpatch.Patch(color='none', label=("Param $\\chi^2_{red}$: " + str(plane_rot_chisq)))
vel_dev_chisq_patch = mpatch.Patch(color='none', label=("Param $\\chi^2_{red}$: " + str(vel_dev_chisq)))
